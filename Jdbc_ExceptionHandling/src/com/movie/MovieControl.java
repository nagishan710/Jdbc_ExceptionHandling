...
public class MovieControl {
	private static final String DB_URL = "jdbc:mysql://localhost:3306/moviesdb";
...
//            createMoviesTable(conn);
	...
	private static void createMoviesTable(Connection conn) throws SQLException {
		String createTableSql = "CREATE TABLE IF NOT EXISTS Movies (" + "movieName VARCHAR(100) PRIMARY KEY,"
				+ "releaseDate DATE," + "productionCost DECIMAL(10, 2)," + "noOfScreensReleased INT,"
				+ "directedBy VARCHAR(100)," + "producedBy VARCHAR(100)," + "status BOOLEAN)";
